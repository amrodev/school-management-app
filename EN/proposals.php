...
<head>
    ...
    <title>Baby Kids - Proposals</title> <!--insert your title here-->
    <?php require 'inc/head_menu.php' ?>

    <?php
    require '../admin/lib/banners.php';
    $_ban = new Banners();
    $banners = $_ban->GetBanners('page', 'Proposals');
    ...
    <section class="nicdark_section" style="background-color: #d1e8b2">
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_12">
                <h1 class="subtitle greydark">Proposal</h1>

                <h3 class="subtitle grey">Enter here your proposal</h3>
                    ...
                    <div
                        ...
                        <div class="nicdark_focus nicdark_width_percentage80">
                            <input class="nicdark_bg_grey2 nicdark_radius nicdark_shadow grey medium subtitle"
                                   type="text" placeholder="Name" value="" size="500">
                        </div>
