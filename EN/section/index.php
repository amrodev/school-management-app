...
<section class="nicdark_section" style="background-color: <?php echo $color_code ?>">
   ...
   <div class="nicdark_container nicdark_clearfix">
        ...
        <?php
          if ($best_grades) 
          {
            ...
            <h1 class="subtitle greydark">Best Grades</h1>            
        </div>
      ...
      <div class="nicdark_space50"></div>
        ...
        if ($STAR) 
         {
           echo '<div class="grid grid_12">
            <h1 class="subtitle greydark">STAR OF THE DAY/WEAK</h1>            
        </div>
   ...
   <div class="nicdark_container nicdark_clearfix">
        ...
        <?php
          ...
          {
            echo ' <div class="grid grid_12">
            <h1 class="subtitle greydark">Latest videos</h1>            
        </div>';
 ...
 <?php
   ...
   {
     echo '<div class="grid grid_12">
            <h1 class="subtitle greydark">Latest Galleries</h1>            
        </div> 
        <br><br><br><br>';
         if (isset($Gall)) 
          {
