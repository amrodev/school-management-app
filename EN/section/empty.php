...
<?php
  ...
  $_ban = new Banners();
  $bann = $_ban->get_by_where('page','KG_Gallery');
  $bann[0]['image'];
?>

<!--start section-->
<section id="nicdark_parallax_title" class="nicdark_section nicdark_imgparallax nicdark_parallaxx_img8" style=" background: url(img/parallax/img1.jpg) 50% 0 fixed;">
    ...
    <div class="nicdark_filter greydark"  style=" background: url(img/<?php echo $border; ?>) 100%; ">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_12" style="background-image: url(img/png.png);    width: 400px;margin-left: -10px;">
