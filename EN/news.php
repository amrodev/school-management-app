...
<head>
    ...
    <title>Salam Academy - News</title> <!--insert your title here-->
    ...
    <section class="nicdark_section" style="background-color: #d1e8b2">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="nicdark_archive1 nicdark_bg_green nicdark_radius nicdark_shadow">';
                    ...
                    <h4 class="white nicdark_margin20">' . $all_news[$i]['title_english'] . '</h4>
                </div>';
                    echo ' <div class="nicdark_margin20">
                    <p class="white">' . $all_news[$i]['short_description_english'] . '</p>
                    <div class="nicdark_space20"></div>
                    <a href="news_details.php?news=' . $enc_id . '" class=" nicdark_press nicdark_btn nicdark_bg_greendark white nicdark_radius nicdark_shadow medium">More Details</a>
                </div>';
                    echo '</div></div>';
                }
