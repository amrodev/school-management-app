...
<head>
    ...
    <title>Baby Kids - Jobs</title> <!--insert your title here-->
    ...
    <section class="nicdark_section" style="background-color: #d1e8b2">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_12">
                <h1 class="subtitle greydark">Our Jobs</h1>
                ...
                if (isset($jobs)) {
                    ...
                    for ($i = 0; $i < $counter; $i++) {
                        ...
                        <div class="nicdark_activity nicdark_marginleft100 nicdark_disable_marginleft_ipadpotr">
                            <div class="nicdark_space20"></div>
                            <h4 class="white">' . $jobs[$i]['title_english'] . '</h4>                        
                            <p class="white">' . $jobs[$i]['short_description_english'] . '</p>
                            <div class="nicdark_space20"></div>
