...
<head>
    ...
    <section class="nicdark_section" style="background-color: #d1e8b2">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            echo '<div class="grid grid_8">
            <img alt="" class="nicdark_radius nicdark_opacity" style="float:left;width:100%;" src="../' . $news[0]['photo'] . '">

            <div class="nicdark_space50"></div>';
            echo '<h1 class="subtitle greydark">' . $news[0]['title_english'] . '</h1>';
            echo '<div class="nicdark_space20"></div><div class="nicdark_divider left small"><span class="nicdark_bg_green nicdark_radius"></span></div>
            <div class="nicdark_space20"></div>';
            echo '<p><span class="white nicdark_dropcap nicdark_bg_green nicdark_radius nicdark_shadow">L</span>' . $news[0]['long_description_english'] . '</p>';
            ?>
