                     ...
                     <div class="form-group">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-lg-10"><textarea class="form-control" placeholder="English text .." id="english_skills" name="english_skills" required="" aria-required="true"></textarea>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="ccomment" class="control-label col-lg-2"></label>
                                <div class="col-lg-10"><textarea class="form-control" placeholder="Arabic text .." id="arabic_skills" name="arabic_skills" required="" aria-required="true"></textarea>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-2">
                           <input type="text" id="datepicker" name="ExpiryDate"></p>
                        </div>  
                        </div>
                        ...
                        <div class="col-lg-2">
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                    <button class="btn btn-success waves-effect waves-light" name="add_job" id="add_job" type="submit">Save</button>
