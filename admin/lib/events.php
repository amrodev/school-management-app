<?php
  ...
  class Events{
    ...
    public function save($id,$title_english,$title_arabic,$day,$month,$year,$linkEN,$linkAR)
  	{
        $message ='';
  	    $this->con_state = $this->connect();
  		  if ($this->con_state) {
              ...
              $fields = "(title_english,title_arabic,Day,Month,Year,linkEN,linkAR)";
  		    	  $values = "( '".$title_english."' , '".$title_arabic."' , '".$day."' , '".$month."' , '".$year."' , '".$linkEN."'  , '".$linkAR."'  )";
