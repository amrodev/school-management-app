                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" align="left">
                                <div class="form">
                                    <form class="cmxform form-horizontal tasi-form" id="add_faq" name="add_faq"
                                          method="post" enctype="multipart/form-data" action="funcs/faq_functions.php"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input class="form-control error" id="english_question"
                                                       name="english_question" type="text" required=""
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <textarea name="english_answer" id="english_answer"
                                                          class="wysihtml5 form-control" rows="9"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="cname" class="control-label col-lg-2">Arabic Question</label>
                                            <div class="col-lg-10">
                                                <input class="form-control error" id="arabic_question"
                                                       name="arabic_question" type="textarea" required=""
                                                       aria-required="true" aria-invalid="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <textarea class="wysihtml5 form-control" name="arabic_answer"
                                                          id="arabic_answer" rows="9"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input class="form-control error" id="cat" name="cat" type="text"
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-offset-2 col-lg-10">
                                                <button class="btn btn-success waves-effect waves-light" name="add_faq"
                                                        id="add_faq" type="submit">Save
                                                </button>
                                            </div>
                                        </div>
                                    </form>
