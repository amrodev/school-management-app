...
<head>
    ...
    $_ban = new Banners();
    $bann = $_ban->get_by_where('page', 'Proposals');
    $bann[0]['image'];
    ?>
    ...
    <section class="nicdark_section" style="background-color: #d1e8b2">
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_12" align="right">
                <h1 class="subtitle greydark">اقتراحات / استفسارات / شكاوى</h1>

                <div class="nicdark_space20"></div>
                <div class="nicdark_divider right big"><span class="nicdark_bg_green nicdark_radius"></span></div>
                <div class="nicdark_space10"></div>
            </div>


            <div class="grid grid_12 nicdark_bg_grey nicdark_shadow nicdark_radius nicdark_relative">
                <div class="nicdark_textevidence" style="height: 400px;">
                    <div
                        ...
                        <div class="nicdark_focus nicdark_width_percentage80">
                            <input class="nicdark_bg_grey2 nicdark_radius nicdark_shadow grey medium subtitle"
                                   type="text" placeholder="الاسم بالكامل" value="" size="500">
                        </div>
                        ...
                        <div class="nicdark_focus nicdark_width_percentage80">
                            <input class="nicdark_bg_grey2 nicdark_radius nicdark_shadow grey medium subtitle"
                                   type="text" placeholder="الهاتف" value="" size="500">
                        </div>
                        <label style="color:red;">* </label>
                        <br> <br> <br>
                        <div class="nicdark_focus nicdark_width_percentage80">
