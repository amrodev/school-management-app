    ...
    <section class="nicdark_section nicdark_margintop45_negative">
        ...
        <div class="news red">
            ...
            <ul align="right">
                ...
                for ($i = 0; $i < $nrecords; $i++) {
                    if (isset($news[$i]['id'])) {
                        echo '<li><a href="">' . $news[$i]['title_arabic'] . '</li>';
                    }
                }
                ?>
            </ul>
        ...
        for ($i = 0; $i < $sections_counter; $i++) {
            ...
            if ($sections[$i]['enabled'] == 1) {
                if ($i == 1) {
                    echo '<div style="background-color: ' . $color[0]['code'] . '; margin-left: 150px;" class="nicdark_textevidence nicdark_width_percentage25  nicdark_shadow nicdark_radius_right" >
                            <div class="nicdark_textevidence" align="center" style="margin-left: 7px;">
                              <div class="nicdark_margin30"  >
                                 <h2  class="white subtitle" "><a style="color: white; class="white" href="section/index.php?color=' . $theme . '&section=' . $sections[$i]['section_name_english'] . '" >' . $sections[$i]['section_name_arabic'] . '</a></h2>
                              </div>
                            </div>
                          </div>';
                } else {
                    echo '<div style="margin-right:5px; margin-left:5px; background-color: ' . $color[0]['code'] . ';" class="nicdark_textevidence nicdark_width_percentage25  nicdark_shadow nicdark_radius_right" >
                            <div class="nicdark_textevidence" align="center" style="margin-left: 0px;">
                              <div class="nicdark_margin30"  >
                                 <h2  class="white subtitle" "><a style="color: white; class="white" href="section/index.php?color=' . $theme . '&section=' . $sections[$i]['section_name_english'] . '" >' . $sections[$i]['section_name_arabic'] . '</a></h2>
                              </div>
                            </div>
