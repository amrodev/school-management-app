                      ...
                      <div class="col-sm-11">
                        <div class="panel panel-default">
                          ...
                          <div class="panel-body" align="left">
                            <div class="form" >
                              <form class="cmxform form-horizontal tasi-form" id="update_album" name="update_album" method="post" enctype="multipart/form-data" action="funcs/gallery_functions.php" novalidate="novalidate">
                                
                                <div class="form-group">
                                  <label for="cname" class="control-label col-lg-2">Album Name</label>
                                  <div class="col-lg-10">
                                    <input class="form-control error" id="title_english" value="<?php echo $album[0]['title_english'];  ?>" name="title_english" type="text" required="" aria-required="true" aria-invalid="true" placeholder="English Name">
                                    <input class="form-control error" id="title_arabic"  value="<?php echo $album[0]['title_arabic'];  ?>" name="title_arabic" type="text" required="" aria-required="true" aria-invalid="true" placeholder="Arabic Name">
                                  </div>
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-10">
                                    ...
                                    <br>
                                    <img width="300" height="180" src="../<?php echo $album[0]['photo'];  ?>">
                                  </div>
                                </div>
                                ...
                                <div class="col-lg-offset-2 col-lg-10">
                                    <button class="btn btn-success waves-effect waves-light" name="update_album" id="update_album" type="submit">Save</button>
