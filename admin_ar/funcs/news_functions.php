...
ini_set('session.bug_compat_42', 0);
  ...
  if (isset($_POST['add_news']))
  {
     ...
     $_news->save($id,$title_english,$title_arabic,$short_description_english,$short_description_arabic,$long_description_english,$long_description_arabic,$pic,$section);
