        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" align="left">
                                    <div class="form">
                                        <form class="cmxform form-horizontal tasi-form" id="add_user" name="add_user" method="post" enctype="multipart/form-data" action="funcs/user_functions.php" novalidate="novalidate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input class="form-control error" id="username" name="username" type="text" required="" aria-required="true" aria-invalid="true">
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-offset-2 col-lg-10">
                                    <button class="btn btn-success waves-effect waves-light" name="add_user" id="add_user" type="submit">Save</button>
