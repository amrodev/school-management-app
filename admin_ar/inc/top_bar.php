            ...
            <div class="topbar-left">
                ...
                <div class="text-center">
                    ...
                    <a href="index.html" class="logo">
                        ...
                        <span> خدمات الادارة ونظم المعلومات</span>
                    ...
                    <div class="">
                        ...
                        <ul class="nav navbar-nav navbar-left pull-left">
                            ...
                            <li class="dropdown"><a href="#" class="dropdown-toggle profile" data-toggle="dropdown"
                                aria-expanded="true">
                                <img src="assets/images/users/avatar-1.jpg" alt="user-img" class="img-circle"></a><ul
                                    class="dropdown-menu">
                                    <li><a href="javascript:void(0)"><i class="md md-face-unlock"></i>Profile</a></li><li>
