<?php
  ...
  class Videos{
    ...
    public function get_videodata($search_by,$value)
    {
    ...
    public function save($id,$title_english,$title_arabic,$description_english,$description_arabic,$img,$embaded_code,$section)
  	{
        $message ='';
  	    $this->con_state = $this->connect();
  		  if ($this->con_state) {
              ...
              $fields = "(title_english,title_arabic,description_english,description_arabic,img,embaded_code,section)";
              $values = '( "'.$title_english.'", "'.$title_arabic.'", "'.$description_english.'", "'.$description_arabic.'", "'.$img.'", "'.$embaded_code.'", "'.$section.'" )';
  		    	  //$values = "( '".$title_english."' , '".$title_arabic."' , '".$description_english."' , '".$description_arabic."' , '".$img."' , '".$embaded_code."' , '".$section."' )";
              $db->insert($this->table_name , $fields , $values );
              echo $message = 'Video added Successful';
  		    } 
