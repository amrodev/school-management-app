<?php
  ...
  class Timetable{
    ...
    public function GetUserResult($search_by,$value)
    {
    ...
    public function TimeTableInnerTables($table2,$table3,$table4,$table5,$selects,$OnStatement1,$OnStatement2,$OnStatement3,$OnStatement4,$WhereStatement)
    {
        $message ='';
        $this->con_state = $this->connect();
        if ($this->con_state) 
        {
          $_db = new Database();
          $newTable = $_db->InnerJoin5($this->table_name,$table2,$table3,$table4,$table5,$selects,$OnStatement1,$OnStatement2,$OnStatement3,$OnStatement4,$WhereStatement);
        } 
        return $newTable;      
    }
