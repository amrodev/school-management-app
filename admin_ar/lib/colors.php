<?php
  ...
  class Colors{
    ...
    public function get_color($search_by,$value)
    {
    ...
    public function save($id,$title_english,$title_arabic,$short_description_english,$short_description_arabic,$long_description_english,$long_description_arabic)
  	{
        $message ='';
  	    $this->con_state = $this->connect();
  		  if ($this->con_state) {
              ...
              $fields = "(title_english,title_arabic,short_description_english,short_description_arabic,long_description_english,long_description_arabic)";
  		    	  $values = "( '".$title_english."' , '".$title_arabic."' , '".$short_description_english."' , '".$short_description_arabic."' , '".$long_description_english."' , '".$long_description_arabic."' )";
